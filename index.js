...
async function startBrowser() {
    ...
    try {
        const browser = await puppeteer.launch({
            headless: "new",
            // This is the absolute path to the browser in the ghcr.io image
