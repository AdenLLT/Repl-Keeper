const puppeteer = require('puppeteer-core'); // Back to core
...
async function startBrowser() {
    console.log("Launching pre-installed Chrome...");
    try {
        const browser = await puppeteer.launch({
            headless: "new",
            executablePath: '/usr/bin/google-chrome', // Official image path
            args: [
                '--no-sandbox',
...
',
        ...
        console.log("SUCCESS: Replit loaded.");
